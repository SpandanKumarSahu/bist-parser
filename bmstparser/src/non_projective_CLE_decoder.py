...
def parse_nonproj(scores):
    ...
    final_edges = chu_liu_edmonds(scores_copy, curr_nodes, oldI, oldO, {}, reps)
...
def chu_liu_edmonds(scores, curr_nodes, oldI, oldO, final_edges, reps):
    '''
    ...
    chu_liu_edmonds(scores, curr_nodes, oldI, oldO, final_edges, reps)
